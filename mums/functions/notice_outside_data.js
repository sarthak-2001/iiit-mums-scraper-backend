...
let noticedataOnlineScraper = async function (cookie, id) {
  try {
    let mainUrl =
      "https://hib.iiit-bh.ac.in/m-ums-2.0/app.pub/nb/nbDet1.php?docid=" + id;
    let option = {
      url: mainUrl,
      simple: false,
      ...
      headers: {
        Cookie: cookie,
        Referer: "https://hib.iiit-bh.ac.in/m-ums-2.0/app.pub/nb/nbList1.php",
      },
    };
    ...
    if (preAttachment == undefined) {
      ...
      isAttach = true;
      url = `https://hib.iiit-bh.ac.in/m-ums-2.0/app.pub/nb/${preAttachment}`;
    }
    let attachmentLink = "";
    if (isAttach == true) {
      let option2 = {
...
module.exports = { noticedataOnlineScraper: noticedataOnlineScraper };
