      ...
      rp.get(option2)
        .then((res) => {
            ...
            const student_id = $('p').children()
                .eq(2)
                .text()
            const student_name = $('p').children()
                .eq(5)
                .text()
            const quiz_1 = $('p').children()
                .eq(8)
                .text()
            const quiz_2 = $('p').children()
                .eq(11)
                .text()
            const midsem = $('p').children()
                .eq(14)
                .text()
            const ta = $('p').children()
                .eq(17)
                .text()
            const endsem = $('p').children()
                .eq(20)
                .text()
            const grade_points = $('p').children()
                .eq(23)
                .text()
            const grade = $('p').children()
                .eq(26)
                .text()
            data.Grades.push({
                student_id,
